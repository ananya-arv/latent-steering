...
if __name__ == "__main__":
    ...
    lstm = LSTMModel()
    lstm.load_state_dict(torch.load("checkpoints/lstm_best_v4.pt", map_location="cpu"))
    lstm = lstm.to(DEVICE)

    transformer = TransformerModel()
    transformer.load_state_dict(torch.load("checkpoints/transformer_best_v4.pt", map_location="cpu"))
